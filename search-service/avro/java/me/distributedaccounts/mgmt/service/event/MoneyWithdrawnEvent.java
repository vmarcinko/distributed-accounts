...
public class MoneyWithdrawnEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public MoneyWithdrawnEvent(me.distributedaccounts.mgmt.service.event.EventData eventData, java.lang.Object stateEffects, java.lang.CharSequence accountId, java.lang.Float amount) {
  ...
  /** Creates a new MoneyWithdrawnEvent RecordBuilder */
  public static me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder newBuilder() {
    return new me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder();
  }
  
  /** Creates a new MoneyWithdrawnEvent RecordBuilder by copying an existing Builder */
  public static me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder newBuilder(me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder other) {
    return new me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder(other);
  }
  
  /** Creates a new MoneyWithdrawnEvent RecordBuilder by copying an existing MoneyWithdrawnEvent instance */
  public static me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder newBuilder(me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent other) {
    return new me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder(other);
  }
  
  /**
   * RecordBuilder for MoneyWithdrawnEvent instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MoneyWithdrawnEvent>
    implements org.apache.avro.data.RecordBuilder<MoneyWithdrawnEvent> {
    ...
    private Builder() {
      super(me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing MoneyWithdrawnEvent instance */
    private Builder(me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent other) {
            super(me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.SCHEMA$);
      if (isValidValue(fields()[0], other.eventData)) {
        this.eventData = data().deepCopy(fields()[0].schema(), other.eventData);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'eventData' field */
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder setEventData(me.distributedaccounts.mgmt.service.event.EventData value) {
    ...
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder clearEventData() {
      eventData = null;
    ...
    /** Sets the value of the 'stateEffects' field */
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder setStateEffects(java.lang.Object value) {
    ...
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder clearStateEffects() {
      stateEffects = null;
    ...
    /** Sets the value of the 'accountId' field */
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder setAccountId(java.lang.CharSequence value) {
    ...
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder clearAccountId() {
      accountId = null;
    ...
    /** Sets the value of the 'amount' field */
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder setAmount(float value) {
    ...
    public me.distributedaccounts.mgmt.service.event.MoneyWithdrawnEvent.Builder clearAmount() {
    ...
    public MoneyWithdrawnEvent build() {
      try {
        MoneyWithdrawnEvent record = new MoneyWithdrawnEvent();
