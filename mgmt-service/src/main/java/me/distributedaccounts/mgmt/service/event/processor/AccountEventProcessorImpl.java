...
public class AccountEventProcessorImpl implements AccountEventProcessor {
    private final Logger logger = LoggerFactory.getLogger(AccountEventProcessorImpl.class);
    ...
    public void processEvent(GenericRecord event) {
        ...
        switch (stateEffectRecordFullName) {
            case "me.distributedaccounts.mgmt.service.event.AccountCreatedEffect":
                accountDao.applyStateEffect(convertToSpecificRecord(AccountCreatedEffect.class, stateEffect));
                break;

            case "me.distributedaccounts.mgmt.service.event.AccountUpdatedEffect":
                accountDao.applyStateEffect(convertToSpecificRecord(AccountUpdatedEffect.class, stateEffect));
                break;

            case "me.distributedaccounts.mgmt.service.event.AccountDeletedEffect":
                accountDao.applyStateEffect(convertToSpecificRecord(AccountDeletedEffect.class, stateEffect));
                break;
